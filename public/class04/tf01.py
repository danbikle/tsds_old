...
# This script should try TensorFlow via examples I see at this URL:
# https://github.com/jasonbaldridge/try-tf

# Demo:
# python tf01.py --train try_tf/simdata/linear_data_train.csv --test try_tf/simdata/linear_data_eval.csv --num_epochs 5 --verbose True
